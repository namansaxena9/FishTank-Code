#using greedy transhipment station genration algorithm (Algorithm 3) COBAC is implemented
#Algorithm 3 is not implemented as a separate function but rather is included in the code of COBAC implicitly
